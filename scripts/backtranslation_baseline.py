...
def main() -> None:
    ...
    if args.log_to_wb:
        ...
        try:
            with open(file_path, 'r') as file:
                ...
                api = data["key"]
                wandb.login(key=api)
            wandb.init(project="detox", name="backtranslation_baseline", entity="speech_sanitizers")
    ...
    # Modified: end the W&B run, if --log_to_wb was specified and wandb session was started
    if args.log_to_wb:
        wandb.finish()
